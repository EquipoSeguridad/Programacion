...
CREATE TABLE Bitacora(
    IdBitacoraERP    INT            AUTO_INCREMENT,
    IdErroresERP     INT            NOT NULL,
    IdPerfiles       INT            NOT NULL,
    IdUsuarios       INT            NOT NULL,
    Timestamp        DATETIME,
    Accion           VARCHAR(20)    NOT NULL,
    PRIMARY KEY (IdBitacoraERP, IdErroresERP, IdPerfiles, IdUsuarios)
)
;
...
CREATE TABLE Catalogos(
    IdCatalogos       INT            AUTO_INCREMENT,
...
CREATE TABLE Notificaciones(
    IdNotificacion    CHAR(10)        NOT NULL,
    IdUsuarios        INT             NOT NULL,
    IdPerfiles        INT             NOT NULL,
    Contenido         VARCHAR(500)    NOT NULL,
    Leido             TINYINT         NOT NULL,
    PRIMARY KEY (IdNotificacion, IdUsuarios, IdPerfiles)
)
;
...
CREATE TABLE Permisos(
    ...
    NombreCat�logo    VARCHAR(50)    NOT NULL,
...
ALTER TABLE Bitacora ADD CONSTRAINT RefUsuarios62
    FOREIGN KEY (IdPerfiles, IdUsuarios)
    REFERENCES Usuarios(IdUsuarios, IdPerfiles)
;

ALTER TABLE Bitacora ADD CONSTRAINT RefErroresERP64
